...
export default {
  ...
  generalInfotooltips: {
    ...
    loanMaxLtv: [
      ...
      <>
        The maximum ratio between the USD value of a loan (in USDaf) and the collateral backing it. The LTV will
    ...
    interestRateBoldPerYear: [
      "Interest rate",
      <>
        The annualized interest amount in USDaf for the selected interest rate. The accumulated interest is added to the
        loan.
      </>,
    ],
    ...
    redeemedLoan: {
      ...
      body: (
        <>
          When USDaf trades for under $1, anyone can redeem positions to get USDaf back at $1. Positions with the lowest
